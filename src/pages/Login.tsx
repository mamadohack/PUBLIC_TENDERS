...
function Login() {
  ...
  if (login) return <div>login active</div>;
  return (
    <main className="min-h-svh bg-gray-300 flex items-center justify-center">
      <div className="p-3 bg-white flex rounded-lg drop-shadow-xl items-center gap-10 max-w-6xl">
        <div className="w-1/2 p-5">
          <Form>
            ...
            <h2 className="font-semibold text-3xl text-gray-900 mb-3">
              Holla,
            </h2>
            <h2 className="font-semibold text-3xl text-gray-900 mb-3">
            ...
            <div className="mb-5">
              <div className="flex justify-between max-w-md items-center">
                ...
                <p className="text-gray-500 text-sm">Mot de passe oublié ?</p>
              </div>
            </div>
            <Link to={"/login"}>
              <button
        ...
        <div className="w-1/2">
          <div className="relative overflow-hidden group rounded-lg">
            <img
              ...
              alt=""
              className=" object-cover min-h-[500px] group-hover:scale-[1.05] duration-200"
